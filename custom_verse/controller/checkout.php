...
if(isset($_POST['checkout'])){
  ...
  $qty=$row['cr_qty'];
    ...
    $cvv=$_POST['cvv'];
    $pay_status='pending';
    $stmt3=$admin->cud("INSERT INTO `payment` (`u_id`,`pt_date`,`or_id`,`pt_mode`,`pt_transaction_id`,`pt_card_name`,`pt_card_number`,`cvv`,`pt_status`,`unid`)VALUES('$u_id','$or_id','$pay_type','$trans_id','$card_name','$card_no','$cvv',now(),'$pay_status','$un')",'INSERTED');
