      ...
      <div class="col-12">
        <div class="card mb-4">
          <div class="card-header pb-0">
            <h2 class="font-weight-bolder text-info text-gradient">Profile Details</h2>
            <br><br>
            ...
            <form class="form-detail" action="controller/update_profile.php" method="post" enctype="multipart/form-data">
              <div class="row">
                <div class="col-lg-6">
                <?php
                          $stmt=$admin->ret("SELECT * FROM `admin` where `u_id`='$id'");
                  ...
                  <input type="text" id="admin_name"  placeholder="<?php echo $row2['u_name']?>" value="<?php echo $row2['u_name']?>" value="" name="u_name" required><br><br>

                  <!-- Email Address field -->
                  <label for="admin_email"><h6>Email Address:</h6></label>
                  <input type="email" id="admin_email"  placeholder="<?php echo $row2['u_email']?>" value="<?php echo $row2['u_email']?>" value="" name="u_email" required><br><br>
                </div>
                <div class="col-lg-6">
                  <!-- Current Password field -->
                  <label for="admin_password"><h6>Current Password:</h6></label>
                  <input type="text" id="admin_password" placeholder="<?php echo $row2['u_password']?>" value="<?php echo $row2['u_password']?>" value="" name="u_password" required><br><br>
